...
export default function Swiper() {
	...
	function test1(e) {
		...
		reelRef.current.style.scrollBehavior = "auto";
		itemRef.current.style.scrollSnapAlign = "none";
	}
	...
	function test3(e) {
		setMouseDown(false);
		reelRef.current.style.scrollSnapType = "inline mandatory";
		reelRef.current.style.scrollBehavior = "smooth";
		itemRef.current.style.scrollSnapAlign = "start";
	...
	return (
		<section className="swiper">
			...
			<div className="swiper__reel" ref={reelRef} onMouseDown={e => test1(e)} onMouseMove={e => test2(e)} onMouseLeave={test3} onMouseUp={test3}>
				<div className="swiper__item" ref={itemRef}>
